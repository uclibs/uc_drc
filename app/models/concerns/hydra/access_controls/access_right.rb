module Hydra
  module AccessControls
    class AccessRight
      ...
      VISIBILITY_TEXT_VALUE_ARCHIVE = 'archive'.freeze
      ...
      def private_with_archive_status?
        return false unless permissionable_is_archive?
        return true if has_visibility_text_for?(VISIBILITY_TEXT_VALUE_ARCHIVE)
        # We don't want to know if its under embargo, simply does it have a date.
        # In this way, we can properly inform the label input
        persisted_private_permission? && permissionable.archive_status.present?
      end
      ...
      private
        ...
        def permissionable_is_archive?
          permissionable.respond_to?('archive')
        end
