...
describe Hydra::AccessControls::Visibility do
  describe "setting visibility" do
    ...
    [ Hydra::AccessControls::AccessRight::VISIBILITY_TEXT_VALUE_PRIVATE,
      ...
      Hydra::AccessControls::AccessRight::VISIBILITY_TEXT_VALUE_ARCHIVE ]
    .each do |vis|
      ...
      describe "to #{vis}" do
        ...
        describe "and then to archive" do
          before { subject.visibility=Hydra::AccessControls::AccessRight::VISIBILITY_TEXT_VALUE_ARCHIVE }
          it "should be set to public" do
            expect(subject.visibility).to eql Hydra::AccessControls::AccessRight::VISIBILITY_TEXT_VALUE_ARCHIVE
          end
          it "should have archive permissions only" do
            expect(subject.permissions.map(&:to_hash)).to match_array [
                {type: "group", access: "read", name: Hydra::AccessControls::AccessRight::PERMISSION_TEXT_VALUE_ARCHIVE } ]
          end
        end
